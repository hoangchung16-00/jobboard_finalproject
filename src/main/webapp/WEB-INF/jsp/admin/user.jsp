...
<h4 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">Danh sách ứng viên</h4>
...
<div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
    ...
    <tag-adminPageable:adminPageable currentPage="${currentPage}" totalPage="${totalPage}" size="${user.size()}" total="${total}"/>
</div>