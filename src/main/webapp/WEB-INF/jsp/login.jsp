...
<section class="login-wrapper">
    <div class="container">
        <div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
            ...
            <a href="https://www.facebook.com/dialog/oauth?client_id=309386574033218&redirect_uri=https://localhost:8080/signin/facebook" class="btn btn-lg btn-social btn-facebook">
