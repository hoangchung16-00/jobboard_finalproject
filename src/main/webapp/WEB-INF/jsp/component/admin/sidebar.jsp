...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="/admin/home">Trang chủ</a>
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                <c:if test="${active == 'company'}">
                ...
                <a
                    ...
                    <c:if test="${not (active == 'company')}">
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    </c:if>
                    href="/admin/company"
                >
                    <img src="/admin/image/company.svg" width="19" height="19"/>
                    <span class="ml-4">Nhà tuyển dụng </span>
                </a>
            </li>
        </ul>
        <ul>
            <li class="relative px-6 py-3">
                <c:if test="${active == 'user'}">
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                </c:if>
                <a
                    <c:if test="${active == 'user'}">
                    ...
                    <c:if test="${not (active == 'user')}">
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    </c:if>
                    href="/admin/user"
                >
                    <img src="/admin/image/user.svg" width="19" height="19"/>
                    <span class="ml-4">Ứng viên </span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                <c:if test="${active == 'job'}">
                    <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                </c:if>
                <a
                    <c:if test="${active == 'job'}">
                    ...
                    <c:if test="${not (active == 'job')}">
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    </c:if>
                    href="/admin/job"
                >
                    <img src="/admin/image/jobicon.png" width="19" height="19"/>
                    <span class="ml-4">Tin tuyển dụng </span>
                </a>
            </li>
            <%--<li class="relative px-6 py-3">
